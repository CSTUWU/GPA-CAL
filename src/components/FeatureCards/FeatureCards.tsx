import { User, Check, Cog, Layers } from "lucide-react";
    ...
    <section id="features" className="bg-slate-50 py-24 md:py-28">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-base md:text-[17px] text-slate-500 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Card 1: For Students */}
          <div className="bg-white border border-slate-200/80 rounded-2xl p-8 md:p-10 shadow-sm hover:shadow-lg hover:-translate-y-0.5 hover:border-slate-300 transition-all duration-300 flex flex-col">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-6 bg-[#eeebff] text-primary">
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl p-8 md:p-10 shadow-sm hover:shadow-lg hover:-translate-y-0.5 hover:border-slate-300 transition-all duration-300 flex flex-col">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-6 bg-blue-50 text-[#3b82f6]">
            ...
            <ul className="space-y-3.5">
              <li className="flex items-start gap-3 text-sm font-semibold text-slate-900">
                <Cog size={16} strokeWidth={2.5} className="text-primary mt-0.5 shrink-0" />
