    ...
    <nav className="sticky top-0 z-50 h-18 border-b border-slate-200 bg-white/90 backdrop-blur-md flex items-center">
      <div className="max-w-7xl mx-auto px-6 w-full flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <button className="text-slate-600 hover:text-slate-900 font-semibold text-sm px-4 py-2 transition-colors duration-200 cursor-pointer">
            Log In
          </button>
          <button className="bg-primary text-white font-semibold text-sm px-5 py-2.5 rounded-lg hover:bg-primary-hover hover:-translate-y-px hover:shadow-md hover:shadow-primary/25 active:translate-y-0 active:shadow-sm transition-all duration-200 cursor-pointer">
            Get Started
          </button>
        </div>
      ...
      {isOpen && (
        <div className="absolute top-18 left-0 w-full bg-white border-b border-slate-200 p-6 shadow-lg flex flex-col gap-5 z-40 md:hidden">
          ...
          <div className="flex flex-col gap-3">
            <button className="bg-white text-slate-900 border border-slate-200 font-semibold text-sm px-5 py-2.5 rounded-lg hover:bg-slate-50 transition-all duration-200 cursor-pointer w-full">
              Log In
            </button>
            <button className="bg-primary text-white font-semibold text-sm px-5 py-2.5 rounded-lg hover:bg-primary-hover transition-all duration-200 cursor-pointer w-full">
              Get Started
            </button>
          </div>
        </div>
